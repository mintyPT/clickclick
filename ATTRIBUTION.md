...
- `examples/use-cases/assets/weave-home-ottoman-unsplash.jpg` - Photo by Katsia Jazwinska on Unsplash: https://unsplash.com/photos/fRYJMUmM7PQ
- `examples/use-cases/assets/weave-home-lifestyle-unsplash.jpg` - Photo by Annie Spratt on Unsplash: https://unsplash.com/photos/Bre2Z7HBwlQ
- `examples/use-cases/assets/weave-home-nursery-unsplash.jpg` - Photo by Alexander Mass on Unsplash: https://unsplash.com/photos/fYyc27_cHfQ

Unsplash License: https://unsplash.com/license

## Velora Social Kit

The Velora example set uses source-neutral Unsplash photos passed through template modification JSON files:

- `examples/use-cases/assets/velora-founder-unsplash.jpg` - Photo by Vitaly Gariev on Unsplash: https://unsplash.com/photos/272ClcPZ2Qs
- `examples/use-cases/assets/velora-desk-unsplash.jpg` - Photo by Anil Jose Xavier on Unsplash: https://unsplash.com/photos/pu95Yl-Qp34
